...
namespace LsbyLauncher
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            string appPath = Path.Combine(baseDir, "app", "lsby-punch-in.exe");
            ...
            Console.WriteLine("==================================================");
            Console.WriteLine("lsby-punch-in 启动引导器");
            Console.WriteLine("==================================================");
            ...
            {
                Environment.SetEnvironmentVariable("DEBUG", "@lsby:*,@lsby:punch-in:*");
            }
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("确保 app/lsby-punch-in.exe 存在。");
                Console.WriteLine("按任意键关闭...");
                Console.ReadKey();
                trayIcon.Visible = false;
                Application.Exit();
